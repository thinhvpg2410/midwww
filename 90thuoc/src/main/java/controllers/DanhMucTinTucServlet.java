...
/**
 * Servlet implementation class DanhMucTinTucServlet
 */
@WebServlet(name = "DanhMucTinTucServlet", urlPatterns = { "/DanhMucTinTuc", "/DanhMucTinTuc*" })
public class DanhMucTinTucServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("views/DanhMucTinTuc.jsp");
